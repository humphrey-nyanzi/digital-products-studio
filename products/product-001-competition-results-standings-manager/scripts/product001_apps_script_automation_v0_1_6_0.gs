 ...
 * Apps Script automation v0.1.6.0
 */
const PRODUCT001 = {
  setupSheet: 'Setup',
...
function PRODUCT001_completeResultFormSetup(timeZone) {
  ...
  const detectedTimeZone = PRODUCT001_normalizeSpreadsheetTimeZone_(timeZone);
...
function PRODUCT001_normalizeSpreadsheetTimeZone_(timeZone) {
  ...
  return visibleEquivalent[detectedTimeZone] || detectedTimeZone;
}
