 ...
 * Apps Script automation v0.1.4.6
 */
const PRODUCT001 = {
  setupSheet: 'Setup',
...
function PRODUCT001_closeFormAfterReset_() {
  ...
  const form = FormApp.openById(formId);
  form.setAcceptingResponses(false);
  form.setCustomClosedFormMessage('No fixtures are currently available for result submission. Contact the competition manager.');
