/**
 * Competition Results and Standings Manager
 * Apps Script automation v0.1.5.1
 */
const PRODUCT001 = {
  setupSheet: 'Setup',
...
function PRODUCT001_createBackup_(mode) {
  ...
  backup.setDescription('Automatic competition workbook backup created before a destructive reset on ' + new Date().toISOString() + '.');
  return backup;
}
...
function PRODUCT001_clearSetupData_() {
  ...
  builder.getRange('D11').clearContent();
  builder.getRange('H5:H11').clearContent();
