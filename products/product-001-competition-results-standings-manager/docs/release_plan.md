...
9. Completed: deploy and verify the expanded privacy policy, align the master Start Here notice and canonical User Manual, and document support access, retention and incident-response controls.
10. Completed: return the unchanged OAuth application to review and reply directly to Google in the existing review thread.
