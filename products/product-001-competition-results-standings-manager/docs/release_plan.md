...
2. Install and verify v0.1.5.6. Confirm the Code.gs current-document annotation produces current-workbook, Forms and trigger scopes without customer manifest work, and confirm that full Google Drive and account-wide Sheets access are absent.
