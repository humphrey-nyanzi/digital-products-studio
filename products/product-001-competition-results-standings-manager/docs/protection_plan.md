...
This result does not by itself approve public release. The Google privacy correction is complete. Data-access approval, packaging, outbound support identity, support boundaries and the Director release decision remain open.
